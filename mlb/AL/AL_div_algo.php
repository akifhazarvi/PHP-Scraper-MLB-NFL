...
$sql = "SELECT * FROM american_league ORDER BY ID";
$result = $conn->query($sql);
$result_Team= array();
$result_id= array();
...
$sql = "SELECT * FROM american_league WHERE Division='$Division'ORDER BY Rank   ";
$result = $conn->query($sql);
$Division_Team= array();
$Division_id= array();
$Division_Win= array();

...
$html = file_get_contents('http://espn.go.com/mlb/teams/printSchedule/_/team/mia/season/2015'); //get the html returned from the following url
...
$sql = "INSERT INTO miamimarlins
       (Team_Name,Opponent_Team,Date,Time)
       VALUES ('Miami Marlins','$Opponent_Team','$Date','$Time')"; 
mysql_select_db('mlb');

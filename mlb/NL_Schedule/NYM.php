...
$html = file_get_contents('http://espn.go.com/mlb/teams/printSchedule/_/team/nym/season/2015'); //get the html returned from the following url
...
$sql = "INSERT INTO newyorkmets
       (Team_Name,Opponent_Team,Date,Time)
       VALUES ('New York Mets','$Opponent_Team','$Date','$Time')"; 
mysql_select_db('mlb');

...
$html = file_get_contents('http://espn.go.com/mlb/standings/_/group/league'); //get the html returned from the following url
...
$sql = "UPDATE national_league SET Conf_Rank ='$id' WHERE ID='$temp'";
mysql_select_db('mlb');

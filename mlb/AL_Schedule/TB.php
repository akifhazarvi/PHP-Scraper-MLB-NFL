...
$html = file_get_contents('http://espn.go.com/mlb/teams/printSchedule/_/team/tb/season/2015'); //get the html returned from the following url
...
$sql = "INSERT INTO tempabayrays
       (Team_Name,Opponent_Team,Date,Time)
       VALUES ('Tempa Bay Rays','$Opponent_Team','$Date','$Time')"; 
mysql_select_db('mlb');

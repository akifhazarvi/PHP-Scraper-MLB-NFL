...
$html = file_get_contents('http://espn.go.com/mlb/teams/printSchedule/_/team/bos/season/2015'); //get the html returned from the following url
...
$sql = "INSERT INTO Bostonredsox
       (Team_Name,Opponent_Team,Date,Time)
       VALUES ('Boston Red Sox','$Opponent_Team','$Date','$Time')"; 
mysql_select_db('mlb');

...
$html = file_get_contents('http://espn.go.com/mlb/teams/printSchedule/_/team/tex/season/2015'); //get the html returned from the following url
...
$sql = "INSERT INTO  texasrangers
       (Team_Name,Opponent_Team,Date,Time)
       VALUES (' Texas Rangers','$Opponent_Team','$Date','$Time')"; 
mysql_select_db('mlb');

...
$html = file_get_contents('http://espn.go.com/mlb/teams/printSchedule/_/team/hou/season/2015'); //get the html returned from the following url
...
$sql = "INSERT INTO houstonastros
       (Team_Name,Opponent_Team,Date,Time)
       VALUES ('Houston Astros','$Opponent_Team','$Date','$Time')"; 
mysql_select_db('mlb');
